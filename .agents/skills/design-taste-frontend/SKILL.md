...
* **`MOTION_INTENSITY: 8`** - 1 = Static, 10 = Cinematic / Physics
* **`VISUAL_DENSITY: 5`** - 1 = Art Gallery / Airy, 10 = Cockpit / Packed Data

**Baseline:** `9 / 8 / 5`. Use these unless the design read overrides them. Do not ask the user to edit this file - overrides happen conversationally.
