            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-5 transition-all hover:border-slate-300/80">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
                <div className="text-left">
                  ...
                  <span className="text-2xl font-black font-mono text-emerald-600">{Math.round(cost).toLocaleString('en-US')} VND</span>
                </div>
                <button 
              ...
              <div key={booking.id} className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-5 transition-all hover:border-slate-300/80">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
                  <div className="text-left">
                    ...
                    <span className="text-2xl font-black font-mono text-emerald-600">{(booking.totalAmount ?? booking.depositAmount ?? 0).toLocaleString('en-US')} VND</span>
                  </div>
                  <button 
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="w-full bg-emerald-50 border border-emerald-200 rounded-2xl p-4 my-6 flex justify-between items-center text-xs">
                ...
                <span className="text-base font-black text-[#006d43]">
                  {Math.round(selectedBookingForDeposit.totalAmount ?? selectedBookingForDeposit.depositAmount ?? 0).toLocaleString('en-US')} VND
                </span>
              </div>
